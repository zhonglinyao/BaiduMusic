package com.example.lanou3g.baidumusic.main.lrc.view.impl;
...
import com.example.lanou3g.baidumusic.main.lrc.view.ILrcView;
...
public class LrcView extends View implements ILrcView {
     ...
     * 当前高亮歌词的字体颜色为黄色
     */
    private int mHignlightRowColor = getResources().getColor(R.color.colorMain);
    /**
     * 不高亮歌词的字体颜色为白色
     */
     ...
     **/
    private int mSeekLineColor = Color.RED;
    /**
     * 拖动歌词时，展示当前高亮歌词的时间的字体颜色
     **/
    private int mSeekLineTextColor = Color.RED;
    /**
     ...
     **/
    private int mMinSeekLineTextSize = 17;
    /**
     * 拖动歌词时，展示当前高亮歌词的时间的字体大小最大值
     **/
    private int mMaxSeekLineTextSize = 23;
